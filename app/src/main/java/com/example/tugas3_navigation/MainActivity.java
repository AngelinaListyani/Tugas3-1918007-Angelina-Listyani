...
import com.example.tugas3_navigation.ContactsFragment;
import com.example.tugas3_navigation.EventsFragment;
import com.example.tugas3_navigation.NoteFragment;
import com.example.tugas3_navigation.R;
...
public class  MainActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()){ case R.id.nav_contacts:
